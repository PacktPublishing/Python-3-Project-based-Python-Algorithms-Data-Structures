# We filled in the code for the add_to_file method and also added
# the prep_to_write function as a static method to the student class.

# We then looked at inheritance and built the StudentAthlete class below it.
# Additionally we looked at the isinstance function which will come
# in handy while working with objects.
# The completed code for both classes is below, along with some starter
# execution code
